...
-- custom dependencies 
local lain          = require("lain") -- alternative layouts, asynchronous widgets and utility functions for AwesomeWM
local freedesktop   = require("freedesktop") -- menu and desktop icons support


local menubar = require("menubar") -- TODO: replace with dmenu scripts
...
-- [custom] themes from: https://github.com/lcpz/awesome-copycats
local themes = { --TODO list from directory
    "blackburn", -------------1
    "copland", ---------------2
    "dremora", ---------------3
    "holo", ------------------4
...
awful.spawn.with_shell("mate-polkit") -- session manager
